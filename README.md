...
这是一个专注于 **Python 数据可视化** 的开源项目，汇集了 30+ 种常见及创意图表的实现方式，涵盖电商、业务分析等典型场景。所有示例均基于真实（模拟）数据，可直接用于学习、教学或项目参考。
...
- **Seaborn**：统计图表美化  
- **Plotly**：交互式可视化  
- **Pyecharts**：ECharts 风格高级图表（尤其适用于中文场景）
...
### 1. 克隆项目
```bash
git clone https://github.com/your-username/PythonVisualisation.git
